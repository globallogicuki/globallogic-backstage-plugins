 ...
 * @alpha
 */
export const unleashEntityCardExtension: ExtensionDefinition<any> =
  EntityCardBlueprint.make({
    params: {
      filter: 'kind:component',
      loader: async () => {
        const { EntityUnleashCard } = await import(
          './components/EntityUnleashCard'
        );
 ...
 * @alpha
 */
export const unleashEntityContentExtension: ExtensionDefinition<any> =
  EntityContentBlueprint.make({
    params: {
      ...
      filter: 'kind:component',
      loader: async () => {
        const { EntityUnleashContent } = await import(
          './components/EntityUnleashContent'
        );
