...
export const formatTerraformAssessmentResult = (
  ...
  ) => (
    {
      ...
      driftMetrics: {
        ...
        resourcesUndrifted: terraformAssessmentResult.attributes['resources-undrifted']
      },
      validationMetrics: {
        allChecksSucceeded: terraformAssessmentResult.attributes['all-checks-succeeded'],
