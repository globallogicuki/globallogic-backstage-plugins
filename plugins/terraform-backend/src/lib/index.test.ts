...
describe('lib/index', () => {
  ...
  describe('listOrgRuns', () => {
    ...
    it('should make the HTTP GET request correctly', async () => {
      ...
      expect(axios.get).toHaveBeenCalledWith(
        `${baseUrl}/organizations/${organization}/runs?filter[workspace_names]=workspace-1,workspace-2`,
  ...
  describe('getLatestRunForWorkspaces', () => {
    ...
    it('should make the HTTP GET request correctly', async () => {
      ...
      expect(axios.get).toHaveBeenCalledWith(
        `${baseUrl}/organizations/${organization}/runs?filter[workspace_names]=workspace-1,workspace-2&page[number]=1&page[size]=1`,
        { headers: { Authorization: `Bearer ${token}` } },
      );
    });
